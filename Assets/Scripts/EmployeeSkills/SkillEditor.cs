    ...
    void OnGUI()
    {
        ...
        if (skillSet != null) 
        {
            ...
            if (skillSet.skills.Count > 0) {
                GUILayout.BeginHorizontal();
                viewIndex = Mathf.Clamp(EditorGUILayout.IntField("Current Skill", viewIndex, GUILayout.ExpandWidth(false)), 1, skillSet.skills.Count);
                EditorGUILayout.LabelField("of   " + skillSet.skills.Count.ToString() + "  skills", "", GUILayout.ExpandWidth(false));
                GUILayout.EndHorizontal();
                ...
                skillsArray[viewIndex - 1].skillName = EditorGUILayout.TextField("Skill Name", skillsArray[viewIndex - 1].skillName as string);
                skillsArray[viewIndex - 1].skillSprite = EditorGUILayout.ObjectField("Skill Icon", skillsArray[viewIndex - 1].skillSprite, typeof(Sprite), false) as Sprite;
